# Tomato-Leaf-Disease-diagnosis-using-InceptionV3-
...
IMAGE_SIZE = [224, 224]
train_path = '/content/drive/MyDrive/database/training'  # path of your training data set
valid_path = '/content/drive/MyDrive/database/validation' # path of your testing/validation data set
